            ...
            (data, index) =>
              data && (
                <li className="timeline-item" key={index.toString()}>
                  ...
                  <span className="timeframe">{data.period}</span>
                  <a href={data.validation} target="_blank" rel="noreferrer">
                    <img src={data.image} className="cert-img" />
                  </a>
                </li>
              )
          )}
      ...
      <section className="skill">
        ...
        <ul className="skills-list content-card flex-row">
          ...
          <div className="icon-box" title="figma">
            <img src="./assets/images/figma.svg" alt="Figma" height="28px" />
          </div>
